...
2) Download / Make sure that PyEnv has instance of Python 3.8.10 environment
  => pyenv update
...
5) Create instance of Python 3.8.10
  5.1) creates .python-version file containing the desired version number
    => pyenv local 3.8.10

  5.2) find out path to python 3.8.10
    => pyenv which python
    => gives e.g.: C:\Users\<USER>\.pyenv\pyenv-win\versions\3.8.10\python.exe

  5.3) create the virtual Python environment with correct python version
    => C:\Users\<USER>\.pyenv\pyenv-win\versions\3.8.10\python.exe -m venv .venv
